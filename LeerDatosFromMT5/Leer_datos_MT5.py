...
ACTIVOS=["EURUSD","XAUUSD","USDX","USDJPY","USDCHF","GBPJPY","GER40","NAS100","US500","BTCUSD","ETHUSD"] ##para todos
# ACTIVOS=["EURUSD"] ##para 1
for simbolos in ACTIVOS:
    ticks =  mt5.copy_ticks_from(simbolos, datetime(2022, 1, 31, 19), 100000000, mt5.COPY_TICKS_ALL)  #año,mes,dia,hora
    ...
    ticks_frame.to_csv(simbolos+"Febrero.csv")
